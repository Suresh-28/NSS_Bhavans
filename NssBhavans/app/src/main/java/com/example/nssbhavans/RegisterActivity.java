...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText InputName, InputPhoneNumber, InputPassword,Mail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputPhoneNumber = (EditText) findViewById(R.id.userphn);
    ...
    private void CreateAccount(){
        ...
        else if (TextUtils.isEmpty(password))
        {
            ...
            ValidatephoneNumber(name, phone, password, mail);
        }

    }

    private void ValidatephoneNumber(final String name, final String phone,final String password, String mail1) {
